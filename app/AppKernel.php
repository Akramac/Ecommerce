...
class AppKernel extends Kernel
{
    public function registerBundles()
    {
        $bundles = [
            ...
            new Plog\GeneralBundle\PlogGeneralBundle(),
            new Plog\UserBundle\PlogUserBundle(),
            ...
            new Pages\PaagesBundle\PagesPaagesBundle(),
            new Pages\PagesBundle\PagesPagesBundle(),
            new Page\PagesBundle\PagePagesBundle(),
        ];
